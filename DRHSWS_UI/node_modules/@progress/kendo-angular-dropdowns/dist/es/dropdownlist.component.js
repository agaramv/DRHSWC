...
var DropDownListComponent = /** @class */ (function () {
    ...
    DropDownListComponent.prototype.subscribeEvents = function () {
        ...
        this.selectionSubscription.add(this.selectionService.onSelect.pipe(filter(function (_) { return _this.popupOpen; }), map(this.itemFromEvent.bind(this)))
            .subscribe(this.onSelectionChange.bind(this)));
        // item selection when popup is closed | clicked | enter etc.
        this.selectionSubscription.add(merge(this.selectionService.onSelect.pipe(filter(function (_) { return !_this.popupOpen; })), this.selectionService.onChange).pipe(map(this.itemFromEvent.bind(this)), tap(function (_) { return _this.popupOpen = false; }))

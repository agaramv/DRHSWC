...
export class DropDownListComponent {
    ...
    subscribeEvents() {
        ...
        this.selectionSubscription.add(this.selectionService.onSelect.pipe(filter(_ => this.popupOpen), map(this.itemFromEvent.bind(this)))
            .subscribe(this.onSelectionChange.bind(this)));
        // item selection when popup is closed | clicked | enter etc.
        this.selectionSubscription.add(merge(this.selectionService.onSelect.pipe(filter(_ => !this.popupOpen)), this.selectionService.onChange).pipe(map(this.itemFromEvent.bind(this)), tap(_ => this.popupOpen = false))

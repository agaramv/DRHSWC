...
var DropDownListComponent = /** @class */ (function () {
    ...
    DropDownListComponent.prototype.subscribeEvents = function () {
        ...
        this.selectionSubscription.add(this.selectionService.onSelect.pipe(filter_1.filter(function (_) { return _this.popupOpen; }), map_1.map(this.itemFromEvent.bind(this)))
            .subscribe(this.onSelectionChange.bind(this)));
        // item selection when popup is closed | clicked | enter etc.
        this.selectionSubscription.add(merge_1.merge(this.selectionService.onSelect.pipe(filter_1.filter(function (_) { return !_this.popupOpen; })), this.selectionService.onChange).pipe(map_1.map(this.itemFromEvent.bind(this)), tap_1.tap(function (_) { return _this.popupOpen = false; }))
